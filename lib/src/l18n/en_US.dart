...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'eh2telegraphEndpointHint': 'e.g. http://100.68.253.2:8788 (Tailscale)',
      'eh2telegraphToken': 'Access token',
      'eh2telegraphNotConfigured': 'Not configured',
      'eh2telegraphConfigured': 'Configured',
      'eh2telegraphTestConnection': 'Test connection',
      'eh2telegraphConnectionOk': 'Server reachable',
      'eh2telegraphConnectionFailed': 'Server unreachable',
      'sendToTelegraph': 'Telegraph',
      'sendToTelegraphAccepted': 'Sent to the Telegraph bot; the result will arrive on Telegram',
      'sendToTelegraphFailed': 'Failed to send to the Telegraph bot',
      'eh2telegraphSetting': 'Telegraph bot',
