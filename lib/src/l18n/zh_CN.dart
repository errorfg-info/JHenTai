...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'nhentaiApiKey': 'nhentai API 密钥',
      'nhentaiApiKeyHint': '可选，请在 nhentai.net 账户设置中生成；该密钥会参与云同步。',
      'nhentaiApiKeyConfigured': '已配置',
      'nhentaiApiKeyNotConfigured': '未配置',
      'nhentaiApiSetting': 'nhentai API 密钥',
      'eh2telegraph': 'Telegraph 机器人（eh2telegraph）',
      'eh2telegraphEndpoint': '服务地址',
      'eh2telegraphEndpointHint': '例如 http://100.68.253.2:8788（Tailscale 地址）',
      'eh2telegraphToken': '访问令牌',
      'eh2telegraphNotConfigured': '未配置',
      'eh2telegraphConfigured': '已配置',
      'eh2telegraphTestConnection': '测试连接',
      'eh2telegraphConnectionOk': '服务可达',
      'eh2telegraphConnectionFailed': '服务不可达',
      'sendToTelegraph': 'Telegraph',
      'sendToTelegraphAccepted': '已发送给 Telegraph 机器人，结果将通过 Telegram 通知',
      'sendToTelegraphFailed': '发送给 Telegraph 机器人失败',
      'eh2telegraphSetting': 'Telegraph 机器人',
      'nhentaiApiKeyVerified': '已验证为 @username',
      'nhentaiApiKeyValidationFailed': 'API 密钥验证失败。',
      'nhentaiArchiveFormat': '归档格式',
      'nhentaiOfficialArchiveHint': '使用官方短时效下载链接，恢复任务时会自动刷新。',
      'nhentaiTagSuggestions': '标签建议',
      'nhentaiSuggestionsReadOnly': 'API 密钥可查看建议；投票需要用户令牌。',
      'nhentaiCommentsReadOnly': '仅使用 API 密钥时，nhentai 评论为只读。',
      'nhentaiBlacklistTag': '将这个标签加入 nhentai 黑名单？',
      'nhentaiUnblacklistTag': '将这个标签移出 nhentai 黑名单？',
      'relatedGalleries': '相关推荐',
      'votes': '票数',
...
favnote：匹配收藏备注
    ...
    ''',
      ...
      'komgaSeriesProgress': '已读 @completed · 阅读中 @ongoing · 未读 @remaining',
