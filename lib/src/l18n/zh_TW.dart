...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'nhentaiApiKey': 'nhentai API 金鑰',
      'nhentaiApiKeyHint': '選填，請在 nhentai.net 帳戶設定中產生；此金鑰會參與雲端同步。',
      'nhentaiApiKeyConfigured': '已設定',
      'nhentaiApiKeyNotConfigured': '未設定',
      'nhentaiApiSetting': 'nhentai API 金鑰',
      'eh2telegraph': 'Telegraph 機器人（eh2telegraph）',
      'eh2telegraphEndpoint': '服務位址',
      'eh2telegraphEndpointHint': '例如 http://100.68.253.2:8788（Tailscale 位址）',
      'eh2telegraphToken': '存取權杖',
      'eh2telegraphNotConfigured': '未設定',
      'eh2telegraphConfigured': '已設定',
      'eh2telegraphTestConnection': '測試連線',
      'eh2telegraphConnectionOk': '服務可達',
      'eh2telegraphConnectionFailed': '服務不可達',
      'sendToTelegraph': 'Telegraph',
      'sendToTelegraphAccepted': '已傳送給 Telegraph 機器人，結果將透過 Telegram 通知',
      'sendToTelegraphFailed': '傳送給 Telegraph 機器人失敗',
      'eh2telegraphSetting': 'Telegraph 機器人',
      'nhentaiApiKeyVerified': '已驗證為 @username',
      'nhentaiApiKeyValidationFailed': 'API 金鑰驗證失敗。',
      'nhentaiArchiveFormat': '歸檔格式',
      'nhentaiOfficialArchiveHint': '使用官方短效下載連結，恢復任務時會自動重新整理。',
      'nhentaiTagSuggestions': '標籤建議',
      'nhentaiSuggestionsReadOnly': 'API 金鑰可查看建議；投票需要使用者權杖。',
      'nhentaiCommentsReadOnly': '僅使用 API 金鑰時，nhentai 評論為唯讀。',
      'nhentaiBlacklistTag': '將這個標籤加入 nhentai 黑名單？',
      'nhentaiUnblacklistTag': '將這個標籤移出 nhentai 黑名單？',
      'relatedGalleries': '相關推薦',
      'votes': '票數',
...
favnote：配對收藏備註
    ...
    ''',
      ...
      'komgaSeriesProgress': '已讀 @completed · 閱讀中 @ongoing · 未讀 @remaining',
