...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'nhentaiApiKey': 'nhentai API 키',
      'nhentaiApiKeyHint':
          '선택 사항입니다. nhentai.net 계정 설정에서 생성하세요. 클라우드 동기화에 포함됩니다.',
      'nhentaiApiKeyConfigured': '설정됨',
      'nhentaiApiKeyNotConfigured': '설정되지 않음',
      'nhentaiApiSetting': 'nhentai API 키',
      'nhentaiApiKeyVerified': '@username 계정으로 확인됨',
      'nhentaiApiKeyValidationFailed': 'API 키를 확인하지 못했습니다.',
      'nhentaiArchiveFormat': '아카이브 형식',
      'nhentaiOfficialArchiveHint': '공식 단기 다운로드 링크를 사용하며 재개할 때 자동으로 갱신합니다.',
      'nhentaiTagSuggestions': '태그 제안',
      'nhentaiSuggestionsReadOnly': 'API 키로 제안을 볼 수 있지만 투표에는 사용자 토큰이 필요합니다.',
      'nhentaiCommentsReadOnly': 'API 키만 사용하는 경우 nhentai 댓글은 읽기 전용입니다.',
      'nhentaiBlacklistTag': '이 태그를 nhentai 차단 목록에 추가할까요?',
      'nhentaiUnblacklistTag': '이 태그를 nhentai 차단 목록에서 제거할까요?',
      'relatedGalleries': '관련 갤러리',
      'votes': '투표',
...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'komgaSeriesProgress': '읽음 @completed · 읽는 중 @ongoing · 읽지 않음 @remaining',
